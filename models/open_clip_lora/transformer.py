...
class ResidualAttentionBlock(nn.Module):
    def __init__(
        ...
        if lora <= 0:
            ...
            self.attn = lora_layers.MultiheadAttention(d_model, n_head, r=lora, lmbda=lmbda)
...
class Transformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, attn_mask: Optional[torch.Tensor] = None, need_weights: bool = False):
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        if lora <= 0:
            ...
            self.conv1 = lora_layers.Conv2d(in_channels=3, out_channels=width, kernel_size=patch_size,
                                            stride=patch_size, bias=False, r=lora)
    ...
    def forward(self, x: torch.Tensor, return_activations: bool = False):
        ...
        if return_activations:
            return pooled, tokens @ self.proj
