...
from models.custom_loralib import mark_only_lora_as_trainable
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if custom_text:
            ...
            model = CLIP(**model_cfg, cast_dtype=cast_dtype, lora=lora)
        ...
        if pretrained:
            ...
            if checkpoint_path:
                ...
                strict = False if lora > 0 else True
...
def create_model_and_transforms(
    ...
    if lora > 0:
        mark_only_lora_as_trainable(model, lora_layers=lora_layers)
